...
namespace B2cWebsiteAdmin.App_Code
{
    public class ClsHomeSection3:GetConnectionString
    {
        ...
        public int HomeSection3Insert(string Div1Image, string Div2Image, string Div3Image,string Div4Image,string Div5Image,string Div6Image, string Section4Heading, string Section4content, string Div1Heading, string Div2Heading, string Div3Heading,string Div4Heading,string Div5Heading, string Div6Heading,string Div1content, string Div2content, string Div3content, string Div4content, string Div5content,string Div6content ,string CreateBy, string updateBy)
        {
            try
            {
                string constr = getconnection();
                SqlConnection con = new SqlConnection(constr);
                SqlCommand cmd = new SqlCommand("SP_HomeSection3", con);
                ...
                cmd.Parameters.AddWithValue("@Div5image", Div5Image);
                cmd.Parameters.AddWithValue("@Div6image", Div6Image);
                ...
                cmd.Parameters.AddWithValue("@Div5heading", Div5Heading);
                cmd.Parameters.AddWithValue("@Div5content", Div5content);
                cmd.Parameters.AddWithValue("@Div6heading", Div6Heading);
                cmd.Parameters.AddWithValue("@Div6content", Div6content);
