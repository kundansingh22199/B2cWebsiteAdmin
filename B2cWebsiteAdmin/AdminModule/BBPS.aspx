                                                ...
                                                <div class="container">
                                                    <div class="content">
                                                        <for>
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    <strong>Heading First :</strong>
                                                                    <asp:TextBox ID="txtfirstheading"  onkeypress="return isAlfa(event,this);" runat="server" placeholder="Type your first heading"></asp:TextBox>
                                                                </div>
                                                                <%--<div class="col-sm-6">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    ...
                                                                    <asp:TextBox ID="txtcontent"  onkeypress="return isAlfa(event,this);" runat="server" placeholder="Type your content "></asp:TextBox>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <strong>Paragraph First :</strong>
                                                                    <asp:TextBox ID="txtparagraph1" onkeypress="return isAlfa(event,this);" runat="server" placeholder="Type your first paragraph"></asp:TextBox>

                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <strong>Paragraph Second :</strong>
                                                                    <asp:TextBox ID="txtparagraph2" onkeypress="return isAlfa(event,this);" runat="server" placeholder="Type your second paragraph"></asp:TextBox>
                                                                </div>

                                                                <div class="col-sm-6">
                                                                    <strong>Paragraph Third :</strong>
                                                                    <asp:TextBox ID="txtparagraph3" onkeypress="return isAlfa(event,this);" runat="server" placeholder="Type your third paragraph"></asp:TextBox>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <strong>Paragraph Fourth :</strong>
                                                                    <asp:TextBox ID="txtparagraph4" onkeypress="return isAlfa(event,this);" runat="server" placeholder="Type your fourth paragraph"></asp:TextBox>
                                                                </div>
                                                                <%--<div class="col-sm-6">
