                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-12 text-center">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <i class="col-sm- fa fa-pencil" aria-hidden="true" style="margin-left: 40px"></i>
                                                            <div class="col-sm-11">
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <h6 style="font-weight: 600">Section First  Content 
                                                            </h6>
                                                            <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <h6 style="font-weight: 600">Section Second  Content 
                                                            </h6>
                                                            <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <h6 style="font-weight: 600">Section Third Content 
                                                            </h6>
                                                            <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <h6 style="font-weight: 600">Section Fourth Content 
                                                            </h6>
                                                            <div class="form-group row">
                    ...
                    <section class="get-in-touch">
                        ...
                        <for class="contact-form row" style="margin-top: -1.5rem">
                            ...
                            <div class="form-field col-lg-6">
                                ...
                                <asp:TextBox ID="txtContent1" onkeypress="return isAlfa(event,this);" runat="server" class="input-text js-input" placeholder="Type Content ..."></asp:TextBox>
                            </div>
                            <div class="form-field col-lg-6 ">
                            ...
                            <div class="form-field col-lg-6 ">
                                <label style="font-weight: 600; font-family: serif">Section Fourth Content</label>
                                <asp:TextBox ID="txtcontent4" onkeypress="return isAlfa(event,this);" runat="server" class="input-text js-input" placeholder="Type Third Content ..."></asp:TextBox>
                            </div>
