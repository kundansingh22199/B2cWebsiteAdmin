                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <asp:TextBox ID="txtownername" onkeypress="return isAlfa(event,this);" runat="server" class="form-control" placeholder="Type your Owner Name" MaxLength="100" MinLenth="20"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-4 col-form-label fillData">Company Name :</label>
                                                                <div class="col-sm-8">
                                                                    <asp:TextBox ID="txtcompanyname" onkeypress="return isAlfa(event,this);" runat="server" MaxLength="150" class="form-control" placeholder="Type your Company Name"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <asp:TextBox ID="txtAdhar" runat="server" class="form-control" MaxLength="12" placeholder="Type your Aadhar No" onkeypress="return isNumber(event)"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-4 col-form-label fillData">Contect No :</label>
                                                                <div class="col-sm-8">
                                                                    <asp:TextBox ID="txtcontact" runat="server" class="form-control" MaxLength="10" placeholder="Type your Contect No" onkeypress="return isNumber(event)"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <asp:TextBox ID="txtaddress" onkeypress="return isNumAlfa(event,this);" runat="server" class="form-control" MaxLength="200" placeholder="Type your Company Address"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                           <div class="form-group row">
                                                                <label class="col-sm-4 col-form-label fillData">Domain Link</label>
                                                                <div class="col-sm-8">
                                                                    <asp:TextBox ID="txtdomainlink" onkeypress="return isUrlValid(event)" runat="server" class="form-control" placeholder="Type your Domain Link" MaxLength="300" MinLenth="20"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-sm-6">
                                                             <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <asp:TextBox ID="txtsupportcontact" runat="server" class="form-control" MaxLength="10" placeholder="Type your Support Contect" onkeypress="return isNumber(event)"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <asp:TextBox ID="ttxapklink" onkeypress="return isUrlValid(event)"  runat="server" class="form-control" placeholder="Type your Apk Link" MaxLength="38" MinLenth="300"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-4 col-form-label fillData">Instagram Link :</label>
                                                                <div class="col-sm-8">
                                                                    <asp:TextBox ID="txtinstagramlink" onkeypress="return isUrlValid(event)" runat="server" class="form-control" placeholder="Type your Instagram Link" MaxLength="300" MinLenth="20"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-4 col-form-label fillData">Facebook Link :</label>
                                                                <div class="col-sm-8">
                                                                    <asp:TextBox ID="txtfacebooklink" onkeypress="return isUrlValid(event)" runat="server" class="form-control" placeholder="Type your Facebook Link" MaxLength="300" MinLenth="20"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-4 col-form-label fillData">Twitter Link :</label>
                                                                <div class="col-sm-8">
                                                                    <asp:TextBox ID="txttwitterlink" onkeypress="return isUrlValid(event)" runat="server" class="form-control" placeholder="Type your Twitter Link" MaxLength="300" MinLenth="20"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-4 col-form-label fillData">Linkdin Link :</label>
                                                                <div class="col-sm-8">
                                                                    <asp:TextBox ID="txtlinkdinlink" onkeypress="return isUrlValid(event)" runat="server" class="form-control" placeholder="Type your Linkdin Link" MaxLength="300" MinLenth="20"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-4 col-form-label fillData">Whatsapp Link :</label>
                                                                <div class="col-sm-8">
                                                                    <asp:TextBox ID="txtwhatsapplink" onkeypress="return isUrlValid(event)" runat="server" class="form-control" placeholder="Type your Whatsapp Link" MaxLength="300" MinLenth="20"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-4 col-form-label fillData">Login Link :</label>
                                                                <div class="col-sm-8">
                                                                    <asp:TextBox ID="txtloginlink" onkeypress="return isUrlValid(event)" oninput="process1(this)" runat="server" class="form-control" placeholder="Type your Login Link" MaxLength="300" MinLenth="20"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                               <div class="form-group row">
