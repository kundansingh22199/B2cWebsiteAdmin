                                               ...
                                               <div>
                                                ...
                                                <for>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <asp:TextBox ID="txtcontent" runat="server"  onkeypress="return isAlfa(event,this);" class="form-control" placeholder="Type your Contant"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-sm-2 col-form-label" style="font-size:20px;font-weight:500">Content 2<sup>nd</sup>:</label>
                                                        <div class="col-sm-10">
                                                            <asp:TextBox ID="txtcontent1" runat="server"  onkeypress="return isAlfa(event,this);" class="form-control" placeholder="Type your link"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
