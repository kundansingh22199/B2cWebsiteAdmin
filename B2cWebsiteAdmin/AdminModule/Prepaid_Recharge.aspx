                                                        ...
                                                        <for>
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    ...
                                                                    <asp:TextBox ID="txtheading1" onkeypress="return isAlfa(event,this);" runat="server" placeholder="Type your first heading"></asp:TextBox>
                                                                </div>
                                                                <%--<div class="col-sm-6">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    ...
                                                                    <asp:TextBox ID="txtcontent1" onkeypress="return isAlfa(event,this);" runat="server" placeholder="Type your content First"></asp:TextBox>
                                                                </div>
                                                               <div class="col-sm-6">
                                                                    <strong>Content  :</strong>
                                                                    <asp:TextBox ID="txtcontent2" onkeypress="return isAlfa(event,this);" runat="server" placeholder="Type your content Second"></asp:TextBox>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <strong>Content  :</strong>
                                                                    <asp:TextBox ID="txtcontent3" onkeypress="return isAlfa(event,this);" runat="server" placeholder="Type your content Third"></asp:TextBox>
                                                                </div>
                                                                <%--<div class="col-sm-6">
