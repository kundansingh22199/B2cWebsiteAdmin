                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-3" >
                                                                <h3>Status </h3>
                                                                <asp:CheckBox runat="server" ID="Slider1CheckBox" style="height:30px" AutoPostBack="true" OnCheckedChanged="Slider1CheckBox_CheckedChanged"/>
                                                            </div>
                                                        </div>
                                                        <hr />
                                                        <div class="row">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-3">
                                                                <h3>Status </h3>
                                                                <asp:CheckBox runat="server" ID="Slider2CheckBox" AutoPostBack="true" OnCheckedChanged="Slider2CheckBox_CheckedChanged" style="height:30px"/>
                                                            </div>
                                                        </div>
                                                        <hr />
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12" runat="server" id="Secondbtnlink" visible="true">
                                                                <div class="card">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-3">
                                                                <h3>Status </h3>
                                                                <asp:CheckBox runat="server" ID="Slider3CheckBox" AutoPostBack="true" OnCheckedChanged="Slider3CheckBox_CheckedChanged" style="height:30px"/>
                                                            </div>
                                                        </div>
                                                        <hr />
                                                        <div class="row">
