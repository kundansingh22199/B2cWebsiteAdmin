                                            ...
                                            <div class="card-block">
                                                ...
                                                <for>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <asp:TextBox ID="txtName" onkeypress="return isAlfa(event,this);" runat="server" class="form-control" placeholder="Type your Name ......" MaxLength="38" MinLenth="20"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            ...
                                                            <asp:DropDownList ID="dd_Role" runat="server" CssClass="form-control">
                                                                ...
                                                                <asp:ListItem>Retrailor</asp:ListItem>
                                                            </asp:DropDownList>
                                                        </div>
                                                    </div>
                                                    <%--<div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <asp:TextBox ID="txtSociallink" onkeypress="return isUrlValid(event)" runat="server" class="form-control" placeholder="Type your link"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-sm-2 col-form-label" style="font-size: 20px; font-weight: 500">Social Link 2<sup>nd</sup>:</label>
                                                        <div class="col-sm-10">
                                                            <asp:TextBox ID="txtSociallink2" onkeypress="return isUrlValid(event)" runat="server" class="form-control" placeholder="Type your link"></asp:TextBox>
                                                        </div>
                                                    </div>

                                                    <div class="form-group row">
                                                        <label class="col-sm-2 col-form-label" style="font-size: 20px; font-weight: 500">Social Link 3<sup>nd</sup>:</label>
                                                        <div class="col-sm-10">
                                                            <asp:TextBox ID="txtSociallink3" onkeypress="return isUrlValid(event)" runat="server" class="form-control" placeholder="Type your link"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12" style="overflow-x: scroll">
                                                        <asp:GridView ID="GridView1" Width="100%" AutoGenerateColumns="False" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical" OnRowEditing="GridView1_RowEditing" OnRowCancelingEdit="GridView1_RowCancelingEdit" OnRowDeleting="GridView1_RowDeleting" OnRowUpdating="GridView1_RowUpdating">
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Social Link 3">
                                                                    <EditItemTemplate>
                                                                        <asp:TextBox ID="txtSocial3" CssClass="form-control" runat="server" Text='<%# Eval("SocialMdaLink3") %>'></asp:TextBox>
                                                                    </EditItemTemplate>
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblSocial3" runat="server" Text='<%# Eval("SocialMdaLink3") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                                                </asp:TemplateField>
