    ...
    public partial class DMT : System.Web.UI.Page
    {
        ...
        public void GetDataDMT()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                lblcontents4.Text = dt.Rows[0]["content4"].ToString();
        ...
        protected void btn_submit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string heading1 = "", content1 = "", content2 = "", content3 = "", content4 = "";
                ...
                {
                    content4 = txtcontent4.Text;
                }
                else
                {
                    content4 = lblcontents4.Text;
                }
                ...
                if (status == true)
                {
                    if (sizematch == true)
                    {
                        ...
                        int result = clsDMT.DataInsertDMt(filename1, heading1, content1, content2, content3, content4,"");
                        if (result > 0)
                        {
                            GetDataDMT();
