                    ...
                    <section class="get-in-touch">
                        ...
                        <for class="contact-form row" style="margin-top: -2.5rem">
                            <div class="form-field col-lg-6">
                                ...
                                <asp:TextBox ID="txtContent1" onkeypress="return isAlfa(event,this);" runat="server" class="input-text js-input" placeholder="Type  First Content ..."></asp:TextBox>
                                <%-- <label class="label" for="name">Name</label>--%>
                            </div>
                            <div class="form-field col-lg-6 ">

                                <asp:TextBox ID="txtcontent2" onkeypress="return isAlfa(event,this);" runat="server" class="input-text js-input" placeholder="Type Second Content ..."></asp:TextBox>
                            </div>
                            <div class="form-field col-lg-6 ">
                                <asp:TextBox ID="txtcontent3" onkeypress="return isAlfa(event,this);" runat="server" class="input-text js-input" placeholder="Type Third Content ..."></asp:TextBox>
                            </div>
                           
                            <div class="form-field col-lg-6">
                                <asp:TextBox ID="txtparagraph1" onkeypress="return isAlfa(event,this);" runat="server" class="input-text js-input" placeholder="Type First Paragraph ..."></asp:TextBox>
                            </div>
                            <div class="form-field col-lg-6">
                                <asp:TextBox ID="txtparagraph2" onkeypress="return isAlfa(event,this);" runat="server" class="input-text js-input" placeholder="Type Second Paragraph ..."></asp:TextBox>
                            </div>
                            <div class="form-field col-lg-6">
                                <asp:TextBox ID="txtparagraph3" onkeypress="return isAlfa(event,this);" runat="server" class="input-text js-input" placeholder="Type Third Paragraph ..."></asp:TextBox>
                            </div>
                            <div class="form-field col-lg-6">
                                <asp:TextBox ID="txtheading1" onkeypress="return isAlfa(event,this);" runat="server" class="input-text js-input" placeholder="Type First Heading ..."></asp:TextBox>
                            </div>
                            <div class="form-field col-lg-6">
                                <asp:TextBox ID="txtheading2" onkeypress="return isAlfa(event,this);" runat="server" class="input-text js-input" placeholder="Type Second Heading ..."></asp:TextBox>
                            </div>
                            <div class="form-field col-lg-6">
                                <asp:TextBox ID="txtheading3" onkeypress="return isAlfa(event,this);" runat="server" class="input-text js-input" placeholder="Type Third Heading ..."></asp:TextBox>
                            </div>
                            ...
                            <div class="form-field col-lg-12">
                                <asp:TextBox ID="txtbuttonLink" onkeypress="return isUrlValid(event)" runat="server" class="input-text js-in" placeholder="Type Button Link  ..."></asp:TextBox>
                            </div>
