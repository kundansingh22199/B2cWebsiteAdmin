                                                ...
                                                <div class="tab-pane active" id="SliderSectionOne" runat="server">
                                                    <div class="card">
                                                        <div class="card-header" style="padding: 12px 5px 5px 15px; background-color: #396EB4">
                                                            <h4 style="color: white">Why Us Details</h4>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
  ...
  <%--  ************************ Update Details ******************************--%>
   ...
   <for class="contact-form row" style="margin-top:-2.5rem">
      ...
      <div class="form-field col-lg-6 ">
       ...
       <div class="form-field col-lg-6 ">
        <asp:TextBox ID="txtcontent4" onkeypress="return isAlfa(event,this);" runat="server" class="input-text js-input"  placeholder="Type Fourth Content ..."></asp:TextBox>
      </div>
      <div class="form-field col-lg-6">
         <asp:TextBox ID="txtcontent5" onkeypress="return isAlfa(event,this);" runat="server" class="input-text js-input"  placeholder="Type Fifth Content ..."></asp:TextBox>
      </div>
        <div class="form-field col-lg-6">
